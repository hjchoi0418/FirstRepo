...
public class D09_Regex {
	...
	public static void main(String[] args) {
		...
		*/
		 ...
		 */
		System.out.println(Pattern.matches("s.eep", "s1eep"));		// ¸ğµç ¹®ÀÚ
		...
		/*
		 	ÇØ´ç ÆĞÅÏÀÌ Àû¿ëµÉ ¹®ÀÚÀÇ °³¼ö¸¦ Á¤ÀÇÇÏ´Â ¹æ¹ı
		 	 ...
		 	 2. [ex]{n,m} : {} ¾ÕÀÇ ÆĞÅÏÀÌ ÃÖ¼Ò n°³ ÀÌ»ó ÃÖ´ë m°³ ±îÁö ÀÏÄ¡ÇØ¾ß ÇÑ´Ù.
		...
		System.out.println("--------------------");
		System.out.println(Pattern.matches("[$\\w&&\\D°¡-ÆR][$\\w°¡-ÆR]*", "appleÀº»ç°ú"));
		System.out.println(Pattern.matches("[$\\w&&\\D°¡-ÆR][$\\w°¡-ÆR]*", "a3"));
		System.out.println(Pattern.matches("[$\\w&&\\D°¡-ÆR][$\\w°¡-ÆR]*", "4pple"));
