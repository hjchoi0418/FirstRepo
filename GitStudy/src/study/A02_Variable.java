...
public class A02_Variable {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 프로그래밍 언어에서 =의 의미 : 왼쪽의 변수에 오른쪽의 값을 대입
		a = 5000;
		apple = a + 50;
		...
		a = 50;	// 원래 있던 5000은 사라지고, 50을 덮어쓴다.
		System.out.println("a에 들어있는 값 : " + a);
		
		// # 여러가지 변수 선언 방식
		int b;					// 1. 변수 하나만 선언하기
		int c, d;				// 2. 변수를 한번에 여러개 선언하기
		int e = 55;				// 3. 변수 선언과 동시에 값을 대입
		int f = 99, g = 999;	// 4. 변수 여러개를 선언과 동시에 값을 대입
		
		// 값이 한 번도 대입된 적이 없는 변수는 사용할 수 없다.
		// (초기화되지 않은 변수)
