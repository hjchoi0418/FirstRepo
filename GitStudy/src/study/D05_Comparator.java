...
public class D05_Comparator {
	...
	public static void main(String[] args) {
		...
		System.out.println("podo1 == podo2 : " + (podo1 == podo2));
		System.out.println("podo1.equals(podo2) : " + podo1.equals(podo2));
...
class 포도분류기_포도gno_내림차순 implements Comparator<Grape> {
	@Override
	public int compare(Grape o1, Grape o2) {
		// 문자열의 크기 비교는 이미 String 클래스의 compareTo()메서드에 구현되어 있다.
		return o1.gno.compareTo(o2.gno) * -1;
		
//		if (Integer.parseInt(o1.gno, 4, 8, 10) < Integer.parseInt(o2.gno, 4, 8, 10)) {
//			return 1;
//		} else if (Integer.parseInt(o1.gno, 4, 8, 10) == Integer.parseInt(o2.gno, 4, 8, 10)) {
//			return 0;
//		} else
//			return -1;
...
class Grape {
	private static String[] locationNames = {"말레이시아", "칠레", "홍콩", "싱가포르", "브라질", "호주"};
